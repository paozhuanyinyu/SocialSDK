...
public class Util {
	...
	public static byte[] bmpToByteArray(final Bitmap bmp, final boolean needRecycle) {
		...
		Log.d(TAG,"bitmap length: " + result.length);//32768,10485760
		try {
			output.close();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static String getRandom(Context context) {
		...
		saveStateToSP(context,randomsString);
		return randomsString;

	}

	public static void saveStateToSP(Context context,String randomsString) {
		SharedPreferences preferences = context.getSharedPreferences("weixin_auth", Context.MODE_PRIVATE);
